...
class InputInvoiceMessageContent(InputMessageContent):
    ...
    def __init__(
        ...
        **_kwargs: Any,
        ...
        self.prices = prices
        # Optionals
        self.max_tip_amount = max_tip_amount or None
        self.suggested_tip_amounts = (
            [int(sta) for sta in suggested_tip_amounts] if suggested_tip_amounts else None
        )
        self.provider_data = provider_data
        self.photo_url = photo_url
        self.photo_size = photo_size or None
        self.photo_width = photo_width or None
        self.photo_height = photo_height or None
